...
main:
    bl f3 ; esto se llama branch link, te lleva directamente a una funcion. La funcion f3 en este caso. y deja guardado desde donde fue llamada para que luego
            ...
            ; ESTO TAMBIEN ES LLAMADO BAL, ES DECIR BAL NOMBRE_DE_FUNCION. EN ESTE CASO BAL f3
...
; MANIPULACION DE VALORES BINARIOS
/*MVN

; la instrucción MVN (Move Not) en el conjunto de instrucciones ARM 
; se utiliza para realizar una operación de negación bit a bit (complemento a uno) y 
; mover el resultado a un registro de destino.
; MVN {cond} Rd, Operand2
; R1 = 0x000000F0  ; (en binario: 0000 0000 0000 0000 0000 0000 1111 0000)
MVN R0, R1
R0 = 0xFFFFFF0F  ; (en binario: 1111 1111 1111 1111 1111 1111 0000 1111)

; ES IGUAL QUE MOV SOLO QUE PASA NO A REGISTRO EL VALOR SIN TOCARLO, AGARRA EL BINARIO EQUIVALENTE A ESE VALOR Y INVIERTE LOS 1 POR 0, Y LOS 0 POR 1.
; ES DECR QUE ES LO QUE HACE PASA UN VALOR A UN REGISTRO PERO INVERTIDO· POR EJEMPLO 8, PASARIA DE 1000 A 0111
*/

/*

; ROR LO QUE HACE ES TOMAR UN VALOR Y GUARDARLO EN EL REGISTRO QUE LE DIGAMOS
; PERO PRIMERO AGARRA EL BINARIO EQUIVALENTE Y VA MOVIENDO CADA CIFRA A LA DERECHA SEGUN LE INDIQUEMOS
; ES DECIR POR EJEMPLO TENEMOS 
ROR R0, #8, #2
; EN ESTE CASO EL BINARIO EQUIVALENTE ES 1000, LO QUE HARA ES TIRAR EL 1 Y LUEGO EL 0 HACIA LA DERECHA QUEDANDONOS 0010 Y LO GUARDA EN R0
; TAMBIEN PODEMOS HACER ALGO ASI ROR R0, R1, #2 AGARRA EL REGISTRO R1 MOVERA LAS CIFRAS SEGUN SE LO INDIQUEMOS Y GUARDA EL RESULTADO EN R0
